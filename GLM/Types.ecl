...
EXPORT Types := MODULE
  ...
  /**
    ...
    *
    * @field wi The work-item number.
    * @field valid Boolean TRUE indicates that the data is valid, FALSE
    *              indicates problems with the data.
    * @field message_text A textual description of any errors in the data.
    */
  ...
  /**
    ...
    * @field column the regressor field number.
    * @field max_delta the max_delta value for the regressor.
    * @field iterations the number of iterations used to train the regressor.
    * @field mse the mean square error of the regressor.
    * @field dispersion the dispersion of the regressor.
    */
  EXPORT Regressor_Stats := RECORD
  ...
  /**
    ...
    * @field stats child dataset of Regressor_Stats, one for each regressor in the
    *              work-item.
    * @see Regressor_Stats
    */
